...
# ╔═╡ 3649b930-58c9-11f0-114d-7f237748e87a
using DifferentialEquations, Plots, PlutoUI

# ╔═╡ ec88e791-1be4-40d7-94a2-eeaeb5a9429e
using Base.MathConstants, Measures

# ╔═╡ 21b033af-97f4-4b1d-bda5-191678ba9c4d
TableOfContents()

# ╔═╡ adecf334-5880-4aaa-87e0-e131b2a67521
md"# Name: Student1"

# ╔═╡ e06a2072-dfc2-4391-8639-262ee1a16e87
md"# Continous Compond Interest"

# ╔═╡ 40c6b6cf-eb6a-4dc8-a911-1c1363bbd991
md"The question we need to answer is: Given any period time what is our bank account balance? This is continous not descrete problem because we can choose any interval we want. So what it the maxium value our bank account can be."

# ╔═╡ 501d5ef8-2535-4f8d-bcec-51559f20b1b3
md"## Ordinary Differentail Equation (ODE)"

# ╔═╡ 8fee2c9c-d43d-4f6f-8f93-2f1b47bd3af6
html"""
ODE Equations are concerned with how <u>one thing</u> changes with respect to something else and can be expressed as:
"""

# ╔═╡ 39660cba-868c-4a23-b870-1fae61774914
md"$\frac{du}{dt}=up$"

# ╔═╡ 95222786-b2e6-482d-8ffd-5a455a4e3b58
md"""
Where the direvative of function u with respect to t is equal to the function u multipied by any parameter p that alters u. Function u is the what we are trying to find. In our case the function u expreses how bank account grows, t repersents time and p is our interest rate parameter. 
"""

# ╔═╡ 5b5f0b06-73d5-4d19-b8e5-e3e7d58446bd
md"### DifferentialEquations.jl Package"

# ╔═╡ 194511a6-4716-4937-9800-495aceba7cc0
md"""
To us _DifferentialEquations.jl_ package the function u must be expressed as a Julia funtion: $\frac{du}{dt}=f(u,p,t)$.
"""

# ╔═╡ c5ba5324-745b-48ab-80b1-9a3ddaa6071d
md"## Our compond interest rate problem"

# ╔═╡ a3150a5b-abe6-4c9a-aa0f-a70a47d62b49
md"""
...
# ╔═╡ 12fe3453-7292-4796-b615-7d9c5fea5b3e
md"""
By allowing insterest rate($p$) and time($t$) we can get better understanding of our model of compond interest rates. We can quickly view are model at the exterms. 
"""

# ╔═╡ 6c72145c-5b58-450f-90a1-16f11af5f5db
md"### The Julia function:"

# ╔═╡ 5c6e392f-fcad-4afd-b18e-cfd22ef298e5
f(u, p, t) = u * p

# ╔═╡ 29b02c1d-9689-4129-b441-8302d4c615c8
md"### Variable Assignment"

# ╔═╡ d1291131-3749-4bd3-80da-ac6bcffca58c
md"#### Intial value of our Bank Account: $u_0$"

# ╔═╡ 6e6a4841-f645-42cb-8a09-9a18920cc16c
md"Begining Balance $u_0$: $(@bind u₀ Slider(1.0:1_000, 1.0, true))"

# ╔═╡ f6a8a940-aad3-40c0-b353-c3fd6d5f3e1e
md"#### Annual Interest Rate: $p$"

# ╔═╡ 2d6ba92f-461c-4313-bc2a-93c9a1ee73ae
md"Annual Interest Rate $p$: $(@bind p Slider(0.0:0.01:1.0, 1.0, true))"

# ╔═╡ 10c5423a-286b-4c1b-9bbb-c9bd5c4e41c8
md"#### Intial time value: $t_0$"

# ╔═╡ d56e6d9f-2e27-49f3-b42f-018b7c809991
t₀ = 0

# ╔═╡ c3ce7f6d-b22f-44ae-aca8-ad4a248aec2e
md"#### End time value: $t_n$"

# ╔═╡ 57474618-e6e4-49bc-8994-235a54cc57f6
md"End time value $t_n$: $(@bind tₙ Slider(1.0:1.0:30.0, 1.0, true))"

# ╔═╡ 86f0d594-1536-4448-984d-0306c3790e1e
md"#### Time span in years: $(timespan = (t₀, tₙ))"

# ╔═╡ d252cf51-340f-47dc-bf4b-15d83e7b3213
md"### Setup ODE problem for Julia"

# ╔═╡ 9c073423-d535-4512-9bdb-9214c6c59e18
problem = ODEProblem(f, u₀, timespan, p)

# ╔═╡ 6bb6937b-f27d-497b-bd1c-bc181856415a
md"### Solve problem"

# ╔═╡ 3093a348-c3ce-49d4-9d7d-c78873988e43
solution = solve(problem)

# ╔═╡ 026c7ab1-19dc-4af4-b31f-4e40be1c7815
solution.t

# ╔═╡ dc0a08aa-3f32-455c-bf2d-d8615fc78937
md"### Plot Problem"

# ╔═╡ 71a7e50e-98a3-4ef2-a51c-6aa19842eee1
begin
    plt = plot(solution, legend = false, title = "Compond Interest", xlabel = "years", ylabel = "dollars", linewidth=2, yminorticks=10, xminorticks=10, bottom_margin = 10mm, left_margin = 2mm, right_margin = 5mm, formatter=:plain, widen=true)
	scatter!(plt, [1.0], [ℯ], markersize=5, color=:green)
	hline!(plt, [ℯ], label="", linestyle=:dash, linecolor=:red)
	vline!(plt, [1.0], label="", linestyle=:dash, linecolor=:black)
	annotate!(plt, 0.95, ℯ, text("Euler's Number", :black, :right, 10))
end

# ╔═╡ 33875770-5909-483b-9555-5ce2baa865fd
solution(1.0)

# ╔═╡ e63ff08b-6c1a-472c-b117-61020bc49095
md"## Appenex: Euler's Number"

# ╔═╡ ced13581-f4b6-4be3-9a86-b36069f6b238
EULER = ℯ

# ╔═╡ 6d11841f-e3bf-4c4e-8a6c-87d321cb9889
diff = solution(1.0) - EULER

# ╔═╡ 979b8736-a8e0-4d7a-b2a1-d5065745e852
md"Difference between our solution value $(solution(1.0)) and $(EULER)) is $(diff)"

# ╔═╡ 8d451196-05c8-488d-9a15-ef2b1043b241
md"Why the difference? The difference is caused by floating point rounding and time based sampling. Having it accorate within in 6 significant digits is good enough for for applied applications but not good enough for exact solution."

# ╔═╡ a76f9f83-c8bc-4784-9288-7e208903d13e
round(e, sigdigits=6)

# ╔═╡ 07c55130-d225-4847-9362-804141d67665
round(solution(1.0), sigdigits=6)

# ╔═╡ 4b29d9c6-2bc1-4c7b-8d46-215d57dc2a6b
md"### NASA Side Note"

# ╔═╡ 34e40c14-af9c-45d6-b10b-d581eba3ba9a
md"Note the Apollo on board guidance computer was desinged to have just enough accuracy to go to the moon and back.  NASA choose 15 bits to repersent $pi$ to about 6 significant figures. 14 was not accurate enough and 16 was not needed."

# ╔═╡ a2a6ac43-6982-4a85-8202-73c12db5d44f
round(pi, sigdigits=6)
...
manifest_format = "2.0"
project_hash = "bb24a4d44783bad6b1bd103d01d026afc7766231"
